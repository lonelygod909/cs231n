...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # layer using the keys 'W1' and 'teb1'; use keys 'W2' and 'b2' for the       #
    ...
    def loss(self, X, y=None):
        ...
        dscores, dW, db = affine_backward(dscores, caches[2])
        grads["W3"] = dW
        grads["b3"] = db
        dscores, dW, db = affine_relu_backward(dscores, caches[1])
        grads["W2"] = dW
        grads["b2"] = db
        dscores, dW, db = conv_relu_pool_backward(dscores, caches[0])
        grads["W1"] = dW
        grads["b1"] = db
        for i in range(3):
